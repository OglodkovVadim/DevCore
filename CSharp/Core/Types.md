...
Из статьи про [Memory](Memory.md) мы знаем, что у нас есть две области памяти: стек и куча. Данные, в зависимости от их типа, могут лежать в одной из них. Value type переменные лежат на стеке и хранят данные внутри себя. 
